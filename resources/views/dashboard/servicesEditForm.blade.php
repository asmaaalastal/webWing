  ...
  <section class="section main-section">
    <div class="card mb-6">
      ...
      <div class="card-content">
        <form  method="post" enctype="multipart/form-data" action="{{ URL::to('/updateServices') }}" >
        ...
        <input type="hidden" name="id" value="{{ $service->id }}">
          ...
          <div class="field">
            ...
            <div class="control">
              <textarea name="body" class="textarea" placeholder="{{ $service->body }}"></textarea>
            </div>
          </div>
          <hr>
          <div class="field">
            ...
            <div class="control">
              <textarea name="body_ar" class="textarea" placeholder="{{ $service->body_ar }}"></textarea>
            </div>
          </div>
          <hr>
        <div class="field">
